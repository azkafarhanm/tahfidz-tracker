    ...
    <div className="flex shrink-0 items-center gap-2">
      ...
      {canManage ? (
        <div className="relative" ref={menuRef}>
          ...
          {isOpen ? (
            <div className={`absolute right-0 z-50 w-56 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl shadow-slate-950/10 dark:border-slate-700 dark:bg-slate-900 dark:shadow-none ${flipUpward ? "bottom-full mb-2" : "mt-2"}`}>
              {error ? (
