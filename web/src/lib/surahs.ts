...
export const surahList = [
  ...
  { number: 26, name: "Asy-Syu'ara", ayahs: 227 },
  ...
  { number: 42, name: "Asy-Syura", ayahs: 53 },
  { number: 43, name: "Az-Zukhruf", ayahs: 89 },
  { number: 44, name: "Ad-Dukhan", ayahs: 59 },
  { number: 45, name: "Al-Jasiyah", ayahs: 37 },
  ...
  { number: 51, name: "Adz-Dzariyat", ayahs: 60 },
