...
Versi 1.0.0 · Dokumen pendamping untuk presentasi, demonstrasi, wawancara, dan review teknis.
...
**Jawaban:** Secara teknis bisa karena ini aplikasi Next.js standar, namun belum ada panduan self-hosting resmi. v1.0.0 dirancang untuk Vercel + Neon + Upstash.
...
### Q7.1 — Apa roadmap pasca v1.0.0?

**Jawaban:** v1.0.0 adalah rilis production-ready dengan fokus alur inti (guru & admin), dual-program, ekspor, dan PWA online-first. Tidak ada fitur spesifik yang dijanjikan untuk versi berikutnya.
...
**Jawaban:** Belum tersedia di v1.0.0. Ini adalah ide yang masuk akal untuk masa depan, namun belum ada komitmen atau garis waktu.
...
**Jawaban:** PWA memang *bisa* offline, namun **mutation** (menulis data) offline membutuhkan arsitektur berbeda (background sync, antrian IndexedDB, resolusi konflik). v1.0.0 sengaja memilih **online-first** agar data selalu konsisten dan tidak ada catatan hilang/konflik.
...
**Jawaban:** Vercel mendukung rollback cepat ke deployment sebelumnya. Bug dicatat di `KNOWN_ISSUES.md`, dan perbaikan dikirim melalui `main` yang auto-deploy. Semua bug P0 pra-rilis sudah diselesaikan sebelum v1.0.0.
