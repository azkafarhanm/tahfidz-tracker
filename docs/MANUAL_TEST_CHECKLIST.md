...
- After the one-time initial position, verify unrestricted list scrolling with desktop mouse wheel and trackpad, then Android and iOS touch where available; no hover/highlight may pull the list back
